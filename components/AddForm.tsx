    ...
    >
      ...
      <div className="flex flex-col w-full">
        ...
        <input
          ...
          className="w-full px-3 py-1.5 md:py-2 text-custom-dark-grey rounded-lg bg-white border border-gray-500"
        />
      </div>
      <div className="flex flex-col w-full">
        <label>Name:</label>
      ...
      <button
        type="submit"
        className="w-full bg-custom-dark-grey text-white px-3 py-2 rounded-md cursor-pointer"
      >
        Add Product
      </button>
    </form>
